...
const FIXED_DAILY_TICKET = (process.env.TIMESHEET_FIXED_TICKET || 'PF-20479').trim();
const DEFAULT_FALLBACK_TICKET = (process.env.TIMESHEET_DEFAULT_TICKET || 'PF-16716').trim();
const MEETING_REQUIREMENT_TICKET = (process.env.TIMESHEET_REQUIREMENT_MEETING_TICKET || 'PF-20451').trim();
const MEETING_DEFAULT_TICKET = (process.env.TIMESHEET_MEETING_TICKET || 'PF-20200').trim();
